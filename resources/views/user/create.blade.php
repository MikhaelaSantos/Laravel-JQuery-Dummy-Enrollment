          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>User Form <small>Fill up the form to create a new user account.</small></h2>
                    <div class="clearfix"></div>
                  </div>
                  <div class="x_content">
                    <br />
                    <form action="{{route('user.save')}}" method="POST" id="userForm" data-parsley-validate class="form-horizontal form-label-left">
                      @csrf
                      @method('post')
                      ...
                      <div class="item form-group">
                        ...
                        <span for="role" class="d-flex align-items-center fs-5" id="viewPer"><i class="fa fa-eye"></i></span>
                      </div>
          ...
          <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
              ...
              <div class="modal-body" id="bodyModal">
                ...
                <table id="createRoles-table" class="display" style="width:100%">
                  <thead>
                      <tr>
                        <th>Role</th>
                        <th>Permissions</th>
    ...
    <script>
      ...
      $(document).ready(function () {
        $( "#viewPer" ).on( "click", function() {
          ...
          var groupColumn = 0;
          var table = $('#createRoles-table').DataTable({
            processing: true,
            serverSide: true,
            ajax: {
                url: url,
