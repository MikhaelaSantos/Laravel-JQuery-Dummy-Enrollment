          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Student Form <small>Fill up the form to create a new student.</small></h2>
                    <div class="clearfix"></div>
                  </div>
                  <div class="x_content">
                    <br />
                    <form action="{{route('student.save')}}" method="POST" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                      @csrf
                      @method('post')
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 ">
                          <input id="middle_name" class="form-control @error('middle_name') is-invalid @enderror" type="text" name="middle_name" value="{{ old('middle_name') }}">
                          @error('middle_name') 
                            <span class="text-danger">{{$message}}</span>
                          @enderror
                        </div>
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 ">
                          <input id="birthdate" class="form-control @error('birthdate') is-invalid @enderror" type="date" name="birthdate" value="{{ old('birthdate') }}">
                          @error('birthdate') 
                            <span class="text-danger">{{$message}}</span>
                          @enderror
                        </div>
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 ">
                          <input id="age" class="form-control @error('age') is-invalid @enderror" type="number" name="age" value="{{ old('age') }}" readonly>
                          @error('age') 
                            <span class="text-danger">{{$message}}</span>
                          @enderror
                        </div>
