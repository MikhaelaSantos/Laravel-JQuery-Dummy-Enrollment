          ...
          <div class="">
            ...
            <div class="clearfix"></div>
              ...
              <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Role Form <small>Fill up the form to create a new role.</small></h2>
                    <div class="clearfix"></div>
                  </div>
                  <div class="x_content">
                    <br />
                    <form action="{{route('role.save')}}" method="POST" id="roleForm" data-parsley-validate class="form-horizontal form-label-left">
                      @csrf
                      @method('post')
